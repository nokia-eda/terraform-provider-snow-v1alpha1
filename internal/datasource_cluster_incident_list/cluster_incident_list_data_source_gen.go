...
package datasource_cluster_incident_list
...
func ClusterIncidentListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterIncidentListModel struct {
