	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^Incident$"), ""),
				},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the Incident",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "IncidentSpec defines the desired state of Incident",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "IncidentStatus defines the observed state of Incident",
			},
		},
	}
}
