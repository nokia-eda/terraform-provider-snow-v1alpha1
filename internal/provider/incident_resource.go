...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/resource_incident"
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/tfutils"
)

const (
	create_rs_incident = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/incidents"
	read_rs_incident   = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/incidents/{name}"
	update_rs_incident = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/incidents/{name}"
	delete_rs_incident = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/incidents/{name}"
)
...
func (r *incidentResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_incident, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_incident, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_incident,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *incidentResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_incident, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *incidentResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_incident, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
