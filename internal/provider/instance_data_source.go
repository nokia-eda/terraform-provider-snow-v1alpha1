...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/datasource_instance"
...
const read_ds_instance = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
...
func (d *instanceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_instance.InstanceDataSourceSchema(ctx)
}

func (d *instanceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_instance.InstanceModel
	...
	err = d.client.GetByQuery(ctx, read_ds_instance, map[string]string{
...
func (r *instanceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
