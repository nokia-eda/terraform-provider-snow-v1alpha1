...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/datasource_incident"
...
const read_ds_incident = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/incidents/{name}"
...
func (d *incidentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_incident, map[string]string{
...
func (r *incidentDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
