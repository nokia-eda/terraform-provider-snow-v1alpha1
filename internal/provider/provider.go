...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/eda/utils"
...
var _ provider.Provider = (*snowProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &snowProvider{version: ver}
	}
}
...
func (p *snowProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *snowProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *snowProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "snow-v1alpha1"
	resp.Version = p.version
}

func (p *snowProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterIncidentDataSource,
...
func (p *snowProvider) Resources(ctx context.Context) []func() resource.Resource {
