...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/resource_instance"
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/tfutils"
)

const (
	create_rs_instance = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances"
	read_rs_instance   = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
	update_rs_instance = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
	delete_rs_instance = "/apps/snow.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
)
...
func (r *instanceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_instance.InstanceResourceSchema(ctx)
}

func (r *instanceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_instance.InstanceModel
	...
	err = r.client.Create(ctx, create_rs_instance, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_instance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_instance,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *instanceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_instance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *instanceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_instance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
