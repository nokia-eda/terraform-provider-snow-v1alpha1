...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/resource_cluster_instance"
	"github.com/nokia/eda/apps/terraform-provider-snow/internal/tfutils"
)

const (
	create_rs_clusterInstance = "/apps/snow.eda.nokia.com/v1alpha1/clusterinstances"
	read_rs_clusterInstance   = "/apps/snow.eda.nokia.com/v1alpha1/clusterinstances/{name}"
	update_rs_clusterInstance = "/apps/snow.eda.nokia.com/v1alpha1/clusterinstances/{name}"
	delete_rs_clusterInstance = "/apps/snow.eda.nokia.com/v1alpha1/clusterinstances/{name}"
)

var (
	_ resource.Resource                = (*clusterInstanceResource)(nil)
	_ resource.ResourceWithConfigure   = (*clusterInstanceResource)(nil)
	_ resource.ResourceWithImportState = (*clusterInstanceResource)(nil)
)
...
func (r *clusterInstanceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_cluster_instance.ClusterInstanceResourceSchema(ctx)
}

func (r *clusterInstanceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_cluster_instance.ClusterInstanceModel
	...
	tflog.Info(ctx, "Create()::API request", map[string]any{
		"path": create_rs_clusterInstance,
	...
	err = r.client.Create(ctx, create_rs_clusterInstance, nil, reqBody, &result)
	...
	err = r.client.Get(ctx, read_rs_clusterInstance, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_clusterInstance,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *clusterInstanceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_clusterInstance,
		"body": spew.Sdump(reqBody),
	})
	...
	err = r.client.Update(ctx, update_rs_clusterInstance, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *clusterInstanceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_clusterInstance,
		"data": spew.Sdump(data),
	})
	...
	err := r.client.Delete(ctx, delete_rs_clusterInstance, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *clusterInstanceResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
