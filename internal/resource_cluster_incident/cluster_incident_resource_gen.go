...
package resource_cluster_incident
...
func ClusterIncidentResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterIncident$"), ""),
				},
				Default: stringdefault.StaticString("ClusterIncident"),
			},
